            ...
            <ul className={s.navigation}>
                <li className={s.logo}>
                    <div className={s.navigationLink}>
                        ...
                        <IconButton onClick={props.handleChange} edge="start" className={s.navigationIcon} color="inherit" aria-label="menu">
                            <MenuIcon />
                        </IconButton>
                    </div>
                </li>
                ...
                <li className={s.navigationItem}>
                    {props.isAuth ?
                        <NavLink to="/profile" className={s.navigationLink} activeClassName={s.active}>
                            <img className={s.navigationIcon} src={!props.profile ? userPhoto
                                : (!props.profile.photos.small ? userPhoto : props.profile.photos.small)} alt='avatar'/>
                            <span className={s.linkText}>{props.login}</span>
                            <span className={s.logout}><IconButton color='secondary' aria-label="Logout"
                                                                   onClick={props.logout}> <ExitToAppIcon/></IconButton></span>
                        </NavLink>
                        :
